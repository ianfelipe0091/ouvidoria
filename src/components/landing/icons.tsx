...
/**
 * Ícones da landing — os mesmos traços do lucide que o design de referência
 * usa, copiados aqui para não trazer a biblioteca inteira por 17 ícones.
 * Mantêm o contrato do lucide: 24×24, traço 2, cor herdada.
 */
const PATHS = {
